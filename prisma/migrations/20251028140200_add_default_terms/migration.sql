...
<p>By accessing and using Audio Marker ("the Service"), you accept and agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use the Service.</p>

<h2>2. Description of Service</h2>
<p>Audio Marker is a web application that allows users to upload, store, annotate, and organize audio files with time-based markers and playlists. The Service includes both private and public sharing features.</p>
...
<p>You retain all ownership rights to the audio files and content you upload ("User Content"). By uploading content, you grant us a limited license to:</p>
<ul>
<li>Store and process your audio files</li>
<li>Display your content to you and users you authorize</li>
<li>Make public content available to other users when you explicitly choose to share it</li>
...
<li>You have obtained all necessary permissions and licenses for any content you upload</li>
</ul>
...
<p>We respect intellectual property rights and comply with the Digital Millennium Copyright Act (DMCA). If you believe your copyrighted work has been infringed:</p>
<ul>
<li>Submit a DMCA takedown notice to our contact information below.</li>
<li>Include all required information as specified by DMCA</li>
<li>We will investigate and remove infringing content within 24-48 hours</li>
</ul>
<p><strong>Repeat Infringers:</strong> Users who repeatedly violate copyright will have their accounts terminated.</p>
...
<li>Upload excessively large files or abuse storage resources</li>
...
<ul>
<li>Content marked as "public" will be accessible to anyone with the link</li>
...
<li>Soft-deleted content will be permanently removed after 30 days</li>
...
<p>While we implement backup procedures, <strong>you are responsible for maintaining your own backups</strong> of important content. We are not liable for any data loss, corruption, or deletion.</p>
...
<p>You agree to indemnify and hold harmless Audio Marker, its operators, and affiliates from any claims, damages, losses, or expenses (including legal fees) arising from:</p>
<ul>
...
<p>The Service integrates with third-party services (authentication providers, error tracking, etc.). Your use of these services is subject to their respective terms and policies.</p>
...
<p>We may update these Terms at any time. We will notify users of material changes via:</p>
<ul>
...
<p>These Terms, together with the Privacy Policy and DMCA Policy, constitute the entire agreement between you and Audio Marker.</p>

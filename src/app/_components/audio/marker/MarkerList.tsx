...
export default function MarkerList({ markers, onMarkerClick, onRemoveMarker, onToggleEdit, editingMarkerId }: MarkerListProps) {
          ...
          <div className="flex items-center gap-1">
            {onToggleEdit && (
              <Button
                ...
                startContent={editingMarkerId === marker.id ? <Check size={14} /> : <Pencil size={14} />}
                title={editingMarkerId === marker.id ? t('saveChanges') : t('editMarker')}
              />
            )}
            {onRemoveMarker && (
              <Button
